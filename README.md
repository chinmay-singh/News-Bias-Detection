...
```python train.py --bert --rel --training --lexi_loss_wt 10 --senti_loss_wt 3 --batch_size 16 --lr 3e-5 --n_epochs 20 --patience 7```

```python train.py --joint --rel --training --lexi_loss_wt 10 --senti_loss_wt 3--batch_size 16 --lr 3e-5 --alpha 0.9 --n_epochs 20 --patience 7```

```python train.py --granu --rel --training --lexi_loss_wt 10 --senti_loss_wt 3 --batch_size 16 --lr 3e-5 --alpha 0.9 --n_epochs 20 --patience 7```

```python train.py --mgn --rel --training --lexi_loss_wt 10 --senti_loss_wt 3--batch_size 16 --lr 3e-5 --alpha 0.9 --n_epochs 20 --patience 7```
