...
parser.add_argument("--sig", dest="sig", action="store_true", default=True)
...
parser.add_argument("--group_classes", dest="group_classes", action="store_true", help="WHether or not to group classes in task one")
