...
# Losses
parser.add_argument("--lexical_loss_wt", type=int, default=10, help="Weight for lexical loss")
...
parser.add_argument("--sentiment_loss_wt", type=int, default=1, help="Weight for sentiment loss")
